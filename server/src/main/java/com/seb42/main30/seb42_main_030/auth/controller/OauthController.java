...
public class OauthController {
    ...
    private ResponseEntity<String> getSpotifyAccessToken(String code){
        ...
        headers.add("Authorization", "Basic "+ base64("a74acd41a54442fba564ef852d9a43b0:3ef5274217594784b2fb16e14f3ddf62"));

        //HttpBody에 데이터 담기
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        params.add("grant_type", "authorization_code");
        params.add("code", code);
        params.add("redirect_uri", "http://localhost:8080/callback/login");    //application.yml의 redirect-uri와 동일한 uri
